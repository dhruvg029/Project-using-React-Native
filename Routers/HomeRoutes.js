...
import vendorNotifications from '../Components/VendorPages/notificationVendor';
import sellerNotifications from '../Components/SellerPages/notificationSeller';
        ...
        return(
          <Router>
            <Scene key = "root">
                ...
                <Scene key='vendorNotifications' component={vendorNotifications} title='vendorNotifications'/>
                <Scene key='sellerNotifications' component={sellerNotifications} title='sellerNotifications'/>
