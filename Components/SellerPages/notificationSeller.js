...
class sellerNotifications extends Component {
  ...
  checkredirect = (title) => {
    console.log(title);
    if (title == "new vendor alert") {
      Actions.sellerItems();
    } else {
      Actions.sellerSoldItems();
    }
  };
  render() {
                  ...
                  this.state.notifs.map((notif) => {
                    return (
                      <View style={styles.flag} key={notif._id}>
                        ...
                        <TouchableOpacity
                          style={styles.edits2}
                          onPress={(event) => this.checkredirect(notif.title)}
                        >
                        ...
                        <TouchableOpacity
                          style={styles.edits2}
                          onPress={(event) => this.deletenotifs(notif._id)}
                        >
                          <Text style={styles.textColor}>
...
export default connect(mapStateToProps, null)(sellerNotifications);
